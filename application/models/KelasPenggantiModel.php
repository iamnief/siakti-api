...
class KelasPenggantiModel extends CI_Model
{
	...
	{
		$tgl_ganti = null;
		$this->db->select('kp.status, min(kp.jadwal_kul_kodejdwl) as kodejdwl, kp.tgl_batal, 
		...
		$this->db->group_by('kp.tgl_batal, jk.ruangan_namaruang, mk.namamk, kls.namaklas, kls.kodeklas, kp.status');
